...
export default function HeroBannerBlackRed() {
  return (
    <section className="relative w-full h-[600px] overflow-hidden">
      <div className="absolute inset-0">
        <Image
          src="/images/ae-team-full.jpeg" // Using an existing image from your project
          alt="Allan & Easton Law Team"
          fill
          className="object-cover object-top brightness-75" // Added object-top to show the top portion of the image
          priority
          sizes="100vw"
        />
      </div>
      <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-transparent"></div>
      <div className="absolute inset-0 flex flex-col items-start justify-end pb-12 px-6 md:px-24 text-white max-w-2xl space-y-6">
