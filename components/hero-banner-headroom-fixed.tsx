...
export default function HeroBannerHeadroomFixed() {
  return (
    <section className="relative w-full aspect-[21/9] overflow-hidden">
      <div className="absolute inset-0">
        <Image
          src="/images/ae-team-full.jpeg" // Using existing image, update path if needed
          alt="Allan & Easton Team"
          fill
      ...
      <div className="absolute inset-0 z-20 flex flex-col items-start justify-center px-6 md:px-24 text-white max-w-2xl space-y-6">
